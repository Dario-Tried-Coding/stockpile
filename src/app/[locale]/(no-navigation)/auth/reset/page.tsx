...
const page: FC<pageProps> = ({}) => {
  ...
  return (
    <>
      <h1 className='text-2xl font-semibold tracking-tighter'>{t('Credentials.Reset.heading')}</h1>
      <p className='mt-2 text-sm text-base-500'>{t('Credentials.Reset.footnote')}</p>
      <ResetEmailForm className='mt-6 w-full' />
